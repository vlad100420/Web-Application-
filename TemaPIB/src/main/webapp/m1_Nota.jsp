...
<html style="font-size: 16px;">
  <head>
    ...
    <meta charset="utf-8">
    <meta name="keywords" content="Adauga nota">
...
<link rel="stylesheet" href="Adauga-Nota.css" media="screen">
  ...
  <body data-home-page="Adauga-Nota.html" data-home-page-title="Adauga Nota" class="u-body u-xl-mode"><header class="u-clearfix u-header u-header" id="sec-91b4"><div class="u-clearfix u-sheet u-sheet-1">
       ...
       <%
            jb.connect();
        	String NumeElev, PrenumeElev, Adresa, Telefon, NumeProfesor, Materie, Numar_probleme, Nota_acordata, Data_notare;

            int aux = java.lang.Integer.parseInt(request.getParameter("primarykey"));
            ResultSet rs = jb.intoarceNotaId(aux);
            rs.first();
            int id1 = rs.getInt("idelev_nota");
            int id2 = rs.getInt("idsubiect_nota");
            ...
            Numar_probleme = rs.getString("Numar_probleme");
            Nota_acordata = rs.getString("Nota_acordata");
            Data_notare = rs.getString("Data_notare");
        ...
        <div class="u-container-style u-group u-radius-50 u-shape-round u-white u-group-1">
          <div class="u-container-layout u-container-layout-1">
            ...
            <div class="u-form u-form-1">
              <form action="m2_Nota.jsp" method="POST" class="u-clearfix u-form-custom-backend u-form-spacing-13 u-form-vertical u-inner-form" style="padding: 0;" source="custom" name="form" redirect="true">
                <div class="u-form-group u-form-group-1">
                  <label for="text-cca1" class="u-label u-label-1">IdNota</label>
                  <input type="text" id="text-cca1" name="idnota" class="u-grey-5 u-input u-input-rectangle u-input-1" value="<%= aux%>" readonly/>
                </div>
                <div class="u-form-group u-form-select u-form-group-2">
                  <label for="select-40a4" class="u-label u-label-2">Selectati elevul</label>
                  <div class="u-form-select-wrapper">
                    <select id="select-40a4" name="idelev" class="u-grey-5 u-input u-input-rectangle u-input-2">
                      <%
                                while (rs1.next()) {
                                    ...
                                    if (idelev != id1) {
                            %>
                            <OPTION VALUE="<%= idelev%>"><%= idelev%>, <%= NumeElev%>, <%= PrenumeElev%>, <%= Adresa%>, <%= Telefon%></OPTION>
                                <%
                                        } else {
                                %>                
                            <OPTION selected="yes" VALUE="<%= idelev%>"><%= idelev%>, <%= NumeElev%>, <%= PrenumeElev%>, <%= Adresa%>, <%= Telefon%></OPTION>
                                <%
                                        }
                                    }
                                %>
                ...
                <div class="u-form-group u-form-select u-form-group-3">
                  <label for="select-3c49" class="u-label u-label-3">Selectati subiectul</label>
                  <div class="u-form-select-wrapper">
                    <select id="select-3c49" name="idsubiect" class="u-grey-5 u-input u-input-rectangle u-input-3">
                       <%
                                while (rs2.next()) {
                            ...
                            <OPTION VALUE="<%= idsubiect%>"><%= idsubiect%>, <%= NumeProfesor%>, <%= Materie%>, <%= Numar_probleme%></OPTION>
                                ...
                                %>                
                            <OPTION selected="yes" VALUE="<%= idsubiect%>"><%= idsubiect%>, <%= NumeProfesor%>, <%= Materie%>, <%= Numar_probleme%></OPTION>
                                <%
                                        }
                                    }
                                %>
                ...
                <div class="u-form-group u-form-group-4">
                  <label for="text-226c" class="u-label u-label-4">Nota acordata</label>
                  <input type="text" placeholder="" id="text-226c" name="Nota_acordata" class="u-grey-5 u-input u-input-rectangle u-input-4" required="required">
                </div>
                <div class="u-form-date u-form-group u-form-group-5">
                  <label for="date-33f9" class="u-label u-label-5">Data notare</label>
                  <input type="date" placeholder="" id="date-33f9" name="Data_notare" class="u-grey-5 u-input u-input-rectangle u-input-5" required="required">
                </div>
