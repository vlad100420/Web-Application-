...
<link rel="stylesheet" href="Note.css" media="screen">
  ...
  <jsp:setProperty name="jb" property="*" />
    <body class="u-body"><header class="u-clearfix u-header u-header" id="sec-91b4"><div class="u-clearfix u-sheet u-sheet-1">
        ...
        <%
            jb.connect();
            int aux = java.lang.Integer.parseInt(request.getParameter("idnota"));
            String idelev = request.getParameter("idelev");
            String idsubiect = request.getParameter("idsubiect");
            String Nota_acordata = request.getParameter("Nota_acordata");
            String Data_notare = request.getParameter("Data_notare");
            
            System.out.println(idelev);
            System.out.println(idsubiect);
            System.out.println(Nota_acordata);
            System.out.println(Data_notare);
            
            String[] valori = {idelev, idsubiect, Nota_acordata, Data_notare};
            String[] campuri = {"idelev", "idsubiect", "Nota_acordata", "Data_notare"};
            jb.modificaTabela("note", "idnota", aux, campuri, valori);
            jb.disconnect();
        %>
